...
/*
 ...
 Data: 20/10/2025
 Descrição: Peça ao utilizador a altura em metros e o peso em kg. Calcule o IMC:
`imc = peso / (altura * altura)` e apresente o valor do IMC com uma casa
decimal, juntamente com a classificação correspondente: • IMC < 18.5 → Baixo
peso • 18.5 ≤ IMC < 25.0 → Peso normal • 25.0 ≤ IMC < 30.0 → Excesso de peso
