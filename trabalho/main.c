        ...
        switch (opcao) {
            ...
            case 2:
                if (tipoUtilizador == TIPO_GESTOR) {
                    ...
                    printf("\nErro: Apenas o gestor tem permissão para esta funcionalidade.\n");
            ...
            case 3:
                if (tipoUtilizador == TIPO_GESTOR) {
                    gerirProdutos(produtos, &totalProdutos);
                } else {
                    printf("\nErro: Apenas o gestor tem permissão para esta funcionalidade.\n");
                    printf("Pressione ENTER para continuar...");
                    getchar(); getchar();
                ...
                break;
            case 4:
                gerirTransacoes(transacoes, &totalTransacoes, clientes, totalClientes, produtos, totalProdutos);
                break;
            case 5:
                if (tipoUtilizador == TIPO_GESTOR) {
                    mostrarEstatisticas(clientes, totalClientes, funcionarios, totalFuncionarios, produtos, totalProdutos, transacoes, totalTransacoes);
                } else {
                    printf("\nErro: Apenas o gestor tem permissão para esta funcionalidade.\n");
                    printf("Pressione ENTER para continuar...");
                    getchar(); getchar();
