...
/*
 ...
 Data: 13/10/2025
 Descrição: Leia uma temperatura em graus Celsius e apresente o valor em Fahrenheit e Kelvin. Com duas
casas decimais.
*/
...
int main()
{
    ...
    printf("%.2f Celsius em Kelvin é %.2f e em Farenheif é %.2f", celsius, kelvin, faren);
    return 0;
}
